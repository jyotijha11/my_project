 ...
 */
add_action( 'customize_controls_enqueue_scripts', 'bosa_travelers_blog_custom_customize_enqueue', 999, 1 );

function bosa_travelers_blog_custom_customize_enqueue() {
	wp_enqueue_style( 'bosa-travelers-blog-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css', array( 'bosa-customize-controls' ), '' );
}

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
add_action( 'customize_preview_init', 'bosa_travelers_blog_customize_preview_js', 999, 1 );

function bosa_travelers_blog_customize_preview_js() {
	wp_enqueue_script( 'bosa-travelers-blog-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}
...
add_action( 'init' , 'bosa_travelers_blog_kirki_fields', 999, 1 );

function bosa_travelers_blog_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Blog Homepage Section Title', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-travelers-blog' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-travelers-blog' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-travelers-blog' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-travelers-blog' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Theme Skin', 'bosa-travelers-blog' ),
		'type'        => 'select',
		'settings'    => 'skin_select',
		'section'     => 'skins_options',
		'default'     => 'dark',
		'choices'  => array(
			'default'    => esc_html__( 'Default', 'bosa-travelers-blog' ),
			'dark'       => esc_html__( 'Dark', 'bosa-travelers-blog' ),
			'blackwhite' => esc_html__( 'Black & White', 'bosa-travelers-blog' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Slider Layout', 'bosa-travelers-blog' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-travelers-blog' ),
		'type'        => 'radio-image',
		'settings'    => 'main_slider_layout',
		'section'     => 'main_slider_options',
		'default'     => 'main_slider_two',
		'choices'  => array(
			'main_slider_one'    => get_template_directory_uri() . '/assets/images/slider-layout-1.png',
			'main_slider_two'    => get_stylesheet_directory_uri() . '/assets/images/slider-layout-2.png',
		),
		'active_callback' => array(
			array(
				'setting'  => 'main_slider_controls',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Excerpt', 'bosa-travelers-blog' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-travelers-blog' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-travelers-blog' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-travelers-blog' ),
		'type'        => 'radio-image',
